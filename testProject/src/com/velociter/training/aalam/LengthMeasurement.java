	...
	// Private member variables:
	  ...
	  {   
		if(milliMeter >=0)
		 ...
		 {
			 System.out.println("Invalid Values.Please Try Again With Valid Values1");
			  System.exit(1); 
		 }
	 ...
	 //override toString to display output in M,CM,MM
	  ...
	  { 
		 if(toMillimeter() - length.toMillimeter() > 0)
		 {
			 return new LengthMeasurement(toMillimeter() - length.toMillimeter());
		 }
		 else
		 {
			 return new LengthMeasurement( length.toMillimeter()- toMillimeter() );
		 }
