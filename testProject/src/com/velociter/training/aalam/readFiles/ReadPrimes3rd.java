...
public class ReadPrimes3rd
{
	...
	public static void main(String[] args) 
	{
		...
		int end = 97;
		 ...
		 int index=0;
		System.out.println("from 30 .next 15 Prime numbers stored in file  : ");
		int count;
		...
		String filePath = "E:\\primedata\\NewPrimedata\\prime.txt";
		...
		try
		{
		 ...
		 File fileLocation = new File ("E:\\primedata\\NewPrimedata\\prime.txt");
