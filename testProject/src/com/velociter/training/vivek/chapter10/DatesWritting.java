...
public class DatesWritting
{
  ...
  System.out.println();
         ...
         String directoryName = "c:/AvoidFile";   //we ave to create folder with name proverbs in same location
         String fileName = "abcef.txt";   
	...
	public static void main(String[] args) 
	{
		...
		DatesWritting dateobject = new DatesWritting();
		dateobject.dateFormate();
	}
}
