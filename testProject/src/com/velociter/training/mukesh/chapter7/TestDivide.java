...
public class TestDivide 
{
  ...
  {
    int[] data = {10, 5, 0};		// Array of three integers.
    ...
    try {
      ...
      System.out.println("result = "+divide(data,index));
    } 
    catch(ZeroDivideException e)
    {
      ...
      {										// Verify it is valid and fix up the array...
        data[indexUsed] = 1;					//  ...set the divisor to 1...
        data[indexUsed+1] = data[indexUsed-1];	//  ...and set the result.
      }
