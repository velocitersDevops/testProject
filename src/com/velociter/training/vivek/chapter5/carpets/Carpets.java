package com.velociter.training.vivek.chapter5.carpets;

import com.velociter.training.vivek.chapter5.unitMeasurement.LengthMeasurment;
import com.velociter.training.vivek.chapter5.weightMeaurement.WeightMeasurement;
...
public class Carpets
{
	...
	public static void main(String args[]) 
	{
	    ...
	    WeightMeasurement carpetWeight = null;                                    // Store for reference to weight of a carpet
	    ...
	    for(int i = 0 ; i < carpetLengths.length ; ++i)
	    {
	      ...
	      carpetWeight = new WeightMeasurement(carpetWtPerSqM[i]*carpetArea);
